...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_timer__WEBPACK_IMPORTED_MODULE_3__["default"])('#timer', "2021-07-10");
...
const forms = state => {
  ...
  form.forEach(item => {
    item.addEventListener('submit', e => {
      ...
      postData('http://localhost:3000/items', json).then(res => {
        console.log(res);
...
/* harmony default export */ __webpack_exports__["default"] = (forms); // import {postData} from '../services/service'
...
function tabs(tabsSelector, tabsContentSelector, tabsParentSelector, activeClass, display = 'block') {
  ...
  tabsParent.addEventListener('click', e => {
    ...
    if (target && (target.classList.contains(tabsSelector.slice(1)) || target.parentElement.classList.contains(tabsSelector.slice(1)))) {
      tabs.forEach((item, i) => {
